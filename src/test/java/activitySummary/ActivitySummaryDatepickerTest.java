...
public class ActivitySummaryDatepickerTest extends TestBase {
    ...
    public void setup() {
        ...
        actionsPage.clickOnMenu(actionsPage.activitySummarySubMenu, "Activity Summary");

    }


    @Test(groups = "functional", description = "<em><b>"+"\"This method validates alert message for the same From and To dates\"")
    public void TC_activitySummarySameFromToDates() {
    ...
    public void TC_activitySummaryFutureDate() {
    ...
    public void TC_activitySummaryPastDate() {
    ...
    public void TC_activitySummaryGreaterFromDate() {
